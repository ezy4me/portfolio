        ...
        <div className="projects">
          ...
          >
            ...
            <div className="card__overlay">
              <span className="card__plus" onClick={() => onProjectInfo('Project 1')}>+</span>
            </div>
          </div>
          <div
            className="card"
          ...
          >
            ...
            <div className="card__overlay">
              <span className="card__plus" onClick={() => onProjectInfo('Project 2')}>+</span>
            </div>
          </div>
          <div
            className="card"
          ...
          >
            ...
            <div className="card__overlay">
              <span className="card__plus" onClick={() => onProjectInfo('Project 3')}>+</span>
            </div>
          </div>
          <div
            className="card"
          ...
          >
            ...
            <div className="card__overlay">
              <span className="card__plus" onClick={() => onProjectInfo('Project 4')}>+</span>
            </div>
          </div>
        </div>
      </div>
